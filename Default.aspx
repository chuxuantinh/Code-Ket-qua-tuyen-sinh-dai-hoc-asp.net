...
<body>
    ...
    <div class="style1">
        ...
        TRA CỨU KẾT QUẢ TRÚNG TUYỂN THEO HÌNH THỨC XÉT HỌC BẠ NĂM 2015</span><br />
        </span>
        <br />
    ...
    <div class="style2">
        ...
        &nbsp;&nbsp;&nbsp;<b> Họ và tên: <asp:TextBox ID="mssv" runat="server" Width="134px"></asp:TextBox>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ngày sinh: <asp:TextBox ID="mssv0" runat="server" Width="134px"></asp:TextBox>
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:RequiredFieldValidator ID ="RequiredFieldValidator1" runat="server"  
        ...
        <div align="center" class="auto-style1">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" EnableModelValidation="True">
                <Columns>
                    ...
                    <asp:BoundField DataField="NGANH" HeaderText="Ngành trúng tuyển" />
    ...
    &nbsp;
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT SOPHIEU, HOVATEN, PHAI, NGANH, NGAYSINH, MANGANH FROM KQXT WHERE (HOVATEN = @HOVATEN) AND (NGAYSINH = @ngaysinh)" >
            <SelectParameters>
